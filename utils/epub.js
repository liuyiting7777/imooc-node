    ...
    getImage(id, callback) {
        if (this.manifest[id]) {
            ...
            const coverId = Object.keys(this.manifest).find(key => (
                ...
                // Aimages_978-3-319-64337-3_CoverFigure {
                //     id: 'Aimages_978-3-319-64337-3_CoverFigure',
                //     href: 'OEBPS/images/978-3-319-64337-3_CoverFigure.jpg',
                //     'media-type': 'image/jpeg',
                //     properties: 'cover-image'
                //   }
                
                // 当key所在的对象中properties属性为'cover-image'时，说明该对象为封面。因此将该对象的key返回
